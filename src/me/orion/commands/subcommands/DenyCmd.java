/*    */ package net.orion.commands.subcommands;
/*    */ 
...
/*    */   public DenyCmd(HypixelFriends plugin, Permission permission) {
...
/*    */       return; 
/* 21 */     if (args.length == 1) {
/* 22 */       getPlugin().getMessageUtil().message(user, getPlugin().getConfig().getString("messages.invalid-arguments").replace("%0%", "friend deny <name>"));
/*    */       
/*    */       return;
/*    */     } 
...
/*    */       return;
/*    */     } 
/* 63 */     request.deny(getPlugin());
/*    */     
/* 65 */     for (String line : getPlugin().getConfig().getStringList("messages.request-denied"))
